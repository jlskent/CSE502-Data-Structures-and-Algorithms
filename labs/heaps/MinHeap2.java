...
public class MinHeap2<T extends Comparable<T>> implements PriorityQueue<T> {
...
//constructor
	...
	public MinHeap2(int maxSize, Ticker ticker) {
...
//		return ans;
	...
	public static void main(String[] args) {
		...
		MinHeap2<Integer> test = new MinHeap2<Integer>(500, new Ticker());
//		debug only
//		test.insert(5);
//		test.insert(2);
//		test.insert(3);
...
//		JOptionPane.showMessageDialog(null, "You are welcome to run this, but be sure also to run the TestMinHeap JUnit test");
		MinHeap2<Integer> h = new MinHeap2<Integer>(500, new Ticker());
