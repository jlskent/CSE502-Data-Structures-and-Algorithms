...
public class TestBalancedTree {
	...
	System.out.println("final firstAfter "+tree.firstAfter(tree.getRoot(), 11));
    }
	...
	for (int i= 0; i < num; ++i) {
	    verifySize("before Insert", tree, i);
//		System.out.println("before Insert" + tree.size);
...
//		System.out.println("after Insert Fact" + tree.size);


	}

	System.out.println(TreeToStrings.toTree(tree));
	System.out.println("final firstAfter "+tree.firstAfter(tree.getRoot(), 8));
    ...
    verifySize("after Insert", tree, num);
//	System.out.println(TreeToStrings.toTree(tree));
//	System.out.println("final firstAfter "+tree.firstAfter(tree.getRoot(), 200));
    }
...
//	    I wrote this
		...
		System.out.println(TreeToStrings.toTree(tree));
	    System.out.println("JTest inserting "+ints.get(i));
...
//	    I wrote this
		System.out.println(TreeToStrings.toTree(tree));
	    System.out.println("JTest second inserting "+ints.get(i));
//	    I wrote this
