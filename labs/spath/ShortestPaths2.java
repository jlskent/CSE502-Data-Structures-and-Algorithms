...
public class ShortestPaths2 {
    ...
    // constructor
    //
    public ShortestPaths2(DirectedGraph g, HashMap<Edge,Integer> weights, 
			 Vertex startVertex) {
    	this.g           = g;
...
//    		System.out.println("u "+pq.extractMin());
...
//    		get edges outgoing from u
    		for (Edge v: u.vertex.edgesFrom()) {
    			System.out.println("neightbors " + v);
...
//		    	if we are there we end w subpath
	    		if (v == endVertex) {
			    	System.out.println("end vertex " +v);
	    			break;
	    		}
//	    		else we move on
//		    	get edge of v
